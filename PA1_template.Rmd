...
par(mfrow=c(2,1))
plot(avgStepsPerIntervalWeekend$interval, avgStepsPerIntervalWeekend$avgSteps, type="l", main="weekend")
plot(avgStepsPerIntervalWeekday$interval, avgStepsPerIntervalWeekday$avgSteps, type="l", main="weekday")
```